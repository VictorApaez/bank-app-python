...
def test_open_account():
    bank = Bank('Test Bank')
    customer = Customer('John Doe', '123 Main St')
    account = customer.open_account(bank, '123456', 100)
...
def test_close_account():
    bank = Bank('Test Bank')
    customer = Customer('John Doe', '123 Main St')
    customer.open_account(bank, '123456', 100)
...
def test_transfer_money():
    bank = Bank('Test Bank')
    customer = Customer('John Doe', '123 Main St')
    account1 = customer.open_account(bank, '123456', 100)
    account2 = customer.open_account(bank, '789012', 50)
